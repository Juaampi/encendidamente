...
foreach($orden->productos->unique() as $producto){  
    ...
    $item->picture_url = 'localhost:8000/img-products/' . $producto->img1 . '';    
    $item->quantity = $count; 
                ...
                <div class="col-md-4 offset-md-4 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body" style="background: #f6f6f6">
                            ...
                            <hr style="margin: 2px;">                                                                     
                            <h6 class="text-product-price" style="color: #757575">Total: <span class="text-product-price" style="margin-right: 0%;float: right; font-size: 20px;">${{ $subtotal + 2500}}</span></h6>                              
